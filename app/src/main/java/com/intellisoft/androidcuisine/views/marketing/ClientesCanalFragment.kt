...
import com.intellisoft.androidcuisine.views.adapters.ClientesCanalAdapter

class ClientesCanalFragment : Fragment() {
    ...
    private lateinit var adapter: ClientesCanalAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tvTitle).text = "Clientes por Canal"
        viewModel.loadClientesPorCanal()
    }
    ...
    private fun setupRecyclerView() {
        adapter = ClientesCanalAdapter(clientesSeleccionados)
    ...
    private fun setupListeners() {
        ...
        fabAsignarCampania.setOnClickListener {
            ...
            showAsignarCampaniaDialog("canal")
        }
    }

    private fun observeViewModel() {
        viewModel.clientesCanalState.observe(viewLifecycleOwner) { state ->
            when (state) {
                is ClientesCanalState.Loading -> {
                    progressBar.visibility = View.VISIBLE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.GONE
                }
                is ClientesCanalState.Success -> {
                ...
                is ClientesCanalState.Empty -> {
                    progressBar.visibility = View.GONE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.VISIBLE
                    tvEmpty.text = "No hay clientes"
                    swipeRefresh.isRefreshing = false
                }
                is ClientesCanalState.Error -> {
                    progressBar.visibility = View.GONE
