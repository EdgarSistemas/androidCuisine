...
import com.intellisoft.androidcuisine.views.adapters.ClientesInactivosAdapter

class ClientesInactivosFragment : Fragment() {
    ...
    private lateinit var adapter: ClientesInactivosAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tvTitle).text = "Clientes Inactivos"
        viewModel.loadClientesInactivos(30)
    }
    ...
    private fun setupRecyclerView() {
        adapter = ClientesInactivosAdapter(clientesSeleccionados)
    ...
    private fun setupListeners() {
        ...
        fabAsignarCampania.setOnClickListener {
            ...
            showAsignarCampaniaDialog("inactivos")
        }
    }

    private fun observeViewModel() {
        viewModel.clientesInactivosState.observe(viewLifecycleOwner) { state ->
            when (state) {
                is ClientesInactivosState.Loading -> {
                    progressBar.visibility = View.VISIBLE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.GONE
                }
                is ClientesInactivosState.Success -> {
                ...
                is ClientesInactivosState.Empty -> {
                    progressBar.visibility = View.GONE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.VISIBLE
                    tvEmpty.text = "No hay clientes inactivos"
                    swipeRefresh.isRefreshing = false
                }
                is ClientesInactivosState.Error -> {
                    progressBar.visibility = View.GONE
