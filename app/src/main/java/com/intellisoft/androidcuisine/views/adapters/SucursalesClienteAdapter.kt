...
class SucursalesClienteAdapter(
    private val onItemClick: (SucursalActivaDto) -> Unit
) : ListAdapter<SucursalActivaDto, SucursalesClienteAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_sucursal_cliente, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val layoutTelefono: View = itemView.findViewById(R.id.layoutTelefono)
        ...
        fun bind(sucursal: SucursalActivaDto) {
            ...
            if (sucursal.telefono.isNullOrEmpty()) {
                layoutTelefono.visibility = View.GONE
            } else {
                layoutTelefono.visibility = View.VISIBLE
