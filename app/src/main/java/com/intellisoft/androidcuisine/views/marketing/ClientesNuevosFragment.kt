...
import com.intellisoft.androidcuisine.views.adapters.ClientesNuevosAdapter

class ClientesNuevosFragment : Fragment() {
    ...
    private lateinit var adapter: ClientesNuevosAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tvTitle).text = "Clientes Nuevos"
        viewModel.loadClientesNuevos(30)
    }
    ...
    private fun setupRecyclerView() {
        adapter = ClientesNuevosAdapter(clientesSeleccionados)
    ...
    private fun setupListeners() {
        ...
        fabAsignarCampania.setOnClickListener {
            ...
            showAsignarCampaniaDialog("nuevos")
        }
    }

    private fun observeViewModel() {
        viewModel.clientesNuevosState.observe(viewLifecycleOwner) { state ->
            when (state) {
                is ClientesNuevosState.Loading -> {
                    progressBar.visibility = View.VISIBLE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.GONE
                }
                is ClientesNuevosState.Success -> {
                ...
                is ClientesNuevosState.Empty -> {
                    progressBar.visibility = View.GONE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.VISIBLE
                    tvEmpty.text = "No hay clientes nuevos"
                    swipeRefresh.isRefreshing = false
                }
                is ClientesNuevosState.Error -> {
                    progressBar.visibility = View.GONE
