...
import com.intellisoft.androidcuisine.views.adapters.ClientesVIPAdapter

class ClientesVIPFragment : Fragment() {
    ...
    private lateinit var adapter: ClientesVIPAdapter
    ...
    private fun setupListeners() {
        ...
        fabAsignarCampania.setOnClickListener {
            ...
            showAsignarCampaniaDialog("vip")
        }
    }

    private fun observeViewModel() {
        viewModel.clientesVIPState.observe(viewLifecycleOwner) { state ->
            when (state) {
                is ClientesVIPState.Loading -> {
                    progressBar.visibility = View.VISIBLE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.GONE
                }
                is ClientesVIPState.Success -> {
                ...
                is ClientesVIPState.Empty -> {
                    progressBar.visibility = View.GONE
                    recyclerView.visibility = View.GONE
                    tvEmpty.visibility = View.VISIBLE
                    swipeRefresh.isRefreshing = false
                }
                is ClientesVIPState.Error -> {
                    progressBar.visibility = View.GONE
